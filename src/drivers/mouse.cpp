...
ClickMouseEventHandler::ClickMouseEventHandler() : x(40), y(12)
...
MouseDriver::MouseDriver(InterruptManger *interruptManger, MouseEventHandler *mouseEventHandler)
    : InterruptHandler(0x0c + interruptManger->HardwareInterruptOffset(), interruptManger), dataProt(0x60), // 8042芯片
      commandPort(0x64), offset(0), buttons(0),
